...
#define LV_VDB_SIZE         (240 * LV_HOR_RES)//(30 * LV_HOR_RES)  /*Size of VDB in pixel count (1/10 screen size is good for first)*/
...
#define USE_LV_FILESYSTEM       0//1               /*1: Enable file system (required by images*/
 ...
 */
#define LV_LOG_LEVEL    LV_LOG_LEVEL_INFO//LV_LOG_LEVEL_TRACE//LV_LOG_LEVEL_INFO
...
#define USE_LV_FONT_DEJAVU_20              2//4
#define USE_LV_FONT_DEJAVU_20_LATIN_SUP    0
#define USE_LV_FONT_DEJAVU_20_CYRILLIC     0
#define USE_LV_FONT_SYMBOL_20              2//4
